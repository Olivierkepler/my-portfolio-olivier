...
export default function NewsletterSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-16 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="max-w-xl lg:max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none rounded-md  px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-indigo-500"
              >
                Subscribe
              </button>
            </form>
      ...
      >
        <div
          className="aspect-[1155/678] w-[72rem] "
          // style={{
          //   clipPath:
